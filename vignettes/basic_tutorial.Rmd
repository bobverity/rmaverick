...
myproj <- run_mcmc(myproj, K = 1:5, burnin = 1e1, samples = 1e1, rungs = 1, pb_markdown =  TRUE)
```
...
myproj <- run_mcmc(myproj, K = 1:5, burnin = 1e1, converge_test = 100, samples = 2e1, rungs = 1, pb_markdown = TRUE)
```
