...
This can be caused by a mismatch between versions R and RTools. Make sure you have the correct version of [RTools](https://cran.r-project.org/bin/windows/Rtools/) installed for your version of R, then restart RStudio (or whatever IDE you are using) and try again.
